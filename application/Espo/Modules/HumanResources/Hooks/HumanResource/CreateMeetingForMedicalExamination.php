...
class CreateMeetingForMedicalExamination implements \Espo\Core\Hook\Hook\AfterRelate
{
    ...
    public function afterRelate(
        ...
        if ($relationName !== 'medicalExaminations') {
            return;
        }
        /** @var Date $date */
        ...
        $meeting->set([
            'name' => $this->language->translate('employeeMedicalExamination', 'labels', 'VacationApproval') . ' - ' . $entity->get('name'),
