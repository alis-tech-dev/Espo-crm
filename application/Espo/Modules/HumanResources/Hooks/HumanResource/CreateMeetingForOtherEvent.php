...
class CreateMeetingForOtherEvent implements \Espo\Core\Hook\Hook\AfterRelate
{
    ...
    public function afterRelate(
        ...
        $meeting->set([
            'name' => $relatedEntity->get('type'). ' zaměstnanec - '. $entity->get('name'), //TO-DO translate
