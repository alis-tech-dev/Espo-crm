define(['views/fields/base'], Dep => {
    return class extends Dep {
        editTemplate = 'main:quote/fields/items/edit';
        detailTemplate = 'main:quote/fields/items/detail';
        ...
        setup() {
            ...
            this.wait(
                new Promise(resolve => {
                    this.getModelFactory().create('Quote', async seed => {
                        this.seed = seed;
                        resolve();
                    });
                }),
        ...
        async createEntry(entry) {
            ...
            return await this.createView(entry.key, 'main:views/quote/entry', {
        ...
        getEntries() {
            const entriesData = this.model.get('quoteEntryData') || [];
        ...
        fetch() {
            ...
            return {
                ...
                quoteEntryData: Espo.Utils.cloneDeep(entriesData),
            };
        }
    };
});
