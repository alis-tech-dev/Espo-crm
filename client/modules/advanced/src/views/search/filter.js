...
Espo.define('advanced:views/search/filter', 'view', function (Dep) {

    return Dep.extend({

        template: 'advanced:search/filter',
        ...
        data: function () {
            return {
                ...
                isCustom: this.options.params.isCustom,
                customValue: this.options.params.customValue,
            };
        },
