...
{{#if topBar}}
	<div class="list-buttons-container clearfix">
		<div class="form-group{{#if isWide}} col-lg-12{{/if}} col-md-12 col-sm-12">
			{{#if kanbanLayouts}}
				<div class="btn-group kanban-switcher">
					{{#each kanbanLayouts}}
						<button
							type="button"
							data-name="{{this}}"
							data-action="switchKanbanLayout"
		...
		{{#if displayTotalCount}}
			<div class="text-muted total-count{{#if isWide}} col-lg-12{{/if}} col-md-12 col-sm-12">
				<span
