...
<div class="button-container quote-two-buttons">
    <div>
        <button class="btn btn-default btn-icon" data-action="addItem"
                title="{{translate 'Add Item' scope='Opportunity'}}"><span class="fas fa-plus"></span>
        </button>{{translate 'Add Item' scope='Opportunity'}}
    </div>
</div>
