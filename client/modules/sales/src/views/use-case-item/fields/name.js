...
define('sales:views/use-case-item/fields/name', 'views/fields/varchar', function (Dep) {

    return Dep.extend({

        detailTemplate: 'sales:use-case-item/fields/name/detail',

        listTemplate: 'sales:use-case-item/fields/name/detail',

        listLinkTemplate: 'sales:use-case-item/fields/name/list-link',

        editTemplate: 'sales:use-case-item/fields/name/edit',
