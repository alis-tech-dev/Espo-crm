...
Espo.define('sales:views/use-case/fields/item-list', ['views/fields/base', 'model'], function (Dep, Model) {

    return Dep.extend({

        detailTemplate: 'sales:use-case/fields/item-list/detail',

        listTemplate: 'sales:use-case/fields/item-list/detail',

        editTemplate: 'sales:use-case/fields/item-list/edit',
        ...
        afterRender: function () {
            ...
            var itemListViewName =
                ...
                ||
                'sales:views/use-case/record/item-list';
