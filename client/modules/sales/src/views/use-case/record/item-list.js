...
Espo.define('sales:views/use-case/record/item-list', ['views/base', 'collection'], function (Dep, Collection) {

    return Dep.extend({

        template: 'sales:use-case/record/item-list',
                ...
                this.getModelFactory().create(this.itemEntityType, function (modelSeed) {
                    itemList.forEach(function (item, i) {
                        ...
                        var viewName = this.getMetadata().get(['clientDefs', this.itemEntityType, 'recordViews', 'item']) ||
                            'sales:views/use-case/record/item';
