...
Espo.define('sales:views/use-case/record/item', 'views/base', function (Dep) {

    return Dep.extend({

        template: 'sales:use-case/record/item',
        ...
        customizeFieldOption: function (options, name) {
          return options;
        },
        ...
        setup: function () {
            ...
            this.fieldViewNameMap = {
                name: 'sales:views/use-case-item/fields/name'
            };
            ...
            this.listLayout.forEach(function (item) {
                ...
                var customView = null;
                if (type === 'currency') {
                    customView = 'sales:views/use-case-item/fields/currency-amount-only';
                ...
                this.createField(name, view, this.customizeFieldOption(options, name));
            }, this);
